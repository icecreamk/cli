...
module.exports = class Generator {
  ...
  async initPlugins() {
    ...
    for (const plugin of this.plugins) {
      ...
      // console.log(id, String(apply), options);
  ...
  async generate({
    ...
    // console.log({ filesModifyRecord: this.filesModifyRecord });
  ...
  hasPlugin(id, versionRange) {
    ...
    return semver.satisfies(this.pm.getInstalledVersion(id), versionRange);
  }
