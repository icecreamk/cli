...
const { exit } = require("../../utils/lib/exit");
const { error } = require("../../utils/lib/logger");
const { createSchema, validate } = require("../../utils/lib/validate");
...
const presetSchema = createSchema((joi) =>
  joi.object().keys({
    ...
    cssPreprocessor: joi.string().valid("sass", "dart-sass", "less", "stylus"),
...
exports.defaults = {
  ...
  presets: {
    "Default (Vue 3)": Object.assign(
      { vueVersion: "3" },
      exports.defaultPreset
    ),
    "Default (Vue 2)": Object.assign(
      { vueVersion: "2" },
      exports.defaultPreset
    ),
  },
